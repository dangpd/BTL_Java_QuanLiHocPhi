...
public class ThuChiDauNam extends Thu implements Serializable {

    private Khoa khoa;
    private int soDanhMaTuDong;

    public ThuChiDauNam(Khoa khoa, int soDanhMaTuDong, String tenKhoanThu, double gia) {
        super("TCDN" + String.valueOf(soDanhMaTuDong), "Thu chi đầu năm : " + tenKhoanThu, gia);
        this.khoa = khoa;
